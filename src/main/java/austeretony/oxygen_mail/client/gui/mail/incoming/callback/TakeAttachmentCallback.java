...
public class TakeAttachmentCallback extends AbstractGUICallback {
    ...
    private void confirm() {
        MailManagerClient.instance().getMailboxManager().processMessageOperationSynced(this.section.getCurrentMessageEntry().getWrapped().getId(), EnumMessageOperation.TAKE_ATTACHMENT);
        this.close();
    }
