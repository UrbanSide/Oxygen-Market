...
public class OfferPanelEntry extends OxygenIndexedPanelEntry<OfferClient> {    
    ...
    public OfferPanelEntry(OfferClient offer, OfferProfitability profitability, CurrencyProperties properties, int playerStock, boolean overpriced) {
        ...
        if (!overpriced)
            ...
            this.setDisplayText(this.index.getOfferedStack().getCachedItemStack().getDisplayName());
