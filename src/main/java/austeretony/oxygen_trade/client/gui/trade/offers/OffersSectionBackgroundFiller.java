...
public class OffersSectionBackgroundFiller extends OxygenBackgroundFiller {

    public OffersSectionBackgroundFiller(int xPosition, int yPosition, int width, int height) {             
