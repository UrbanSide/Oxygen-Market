package austeretony.oxygen_market.client.settings.gui;
...
public enum EnumMarketGUISetting {

    //Alignment

    TRADE_MENU_ALIGNMENT("alignment_market_menu", EnumValueType.INT, String.valueOf(0));
    ...
    EnumMarketGUISetting(String key, EnumValueType type, String baseValue) {
        this.key = key;
        this.type = type;
    ...
    public static void register() {
        for (EnumMarketGUISetting setting : values())
