...
public class OffersAmount extends GUISimpleElement<OffersAmount> {
    ...
    public OffersAmount(int x, int y) {
        ...
        this.label = ClientReference.localize("oxygen_market.gui.market.offersAmount");
    ...
    public void updateOffersAmount() {
        this.setOffersAmount(MarketManagerClient.instance().getOffersManager().getPlayerOffersAmount());
    }
    ...
    public void setOffersAmount(int value) {
        ...
        this.offersAmountStr = String.format("%d/%d", value, this.maxAmount);
