...
public class HistoryPanelEntry extends GUIButton {
    ...
    public HistoryPanelEntry(SalesHistoryEntryClient entry, String note, CurrencyProperties properties) {
        ...
        this.setDisplayText(EnumBaseClientSetting.ENABLE_RARITY_COLORS.get().asBoolean() ? this.itemStack.getRarity().color + this.itemStack.getDisplayName() : this.itemStack.getDisplayName());
